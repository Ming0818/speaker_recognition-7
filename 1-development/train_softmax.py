...
def main(_):
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        print("num_samples_per_epoch {0} FLAGS.batch_size {1}".format(num_samples_per_epoch, FLAGS.batch_size))
        num_batches_per_epoch = int(num_samples_per_epoch / FLAGS.batch_size)
        print("num_samples_per_epoch {0}".format(num_batches_per_epoch))
        ...
        """
        speech = tf.placeholder(tf.float32, (1, 80, 40, 1))
        ...
        print('batch_speech {0} batch_labels {1}'.format(batch_speech,batch_labels))
        #############################
            ...
            for i in range(FLAGS.num_clones):
                with tf.device('/gpu:%d' % i):
                    with tf.name_scope('%s_%d' % ('tower', i)) as scope:
                        ...
                        print(batch_speech[i * step: (i + 1) * step])
